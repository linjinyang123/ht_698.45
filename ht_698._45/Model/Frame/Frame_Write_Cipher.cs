...
{
    public class Frame_Write_Cipher
    {
        ...
        public Write_Cipher_APDU mAPDU { get; set; }
        public byte Time = 0;
        ...
        public ushort Length
        {
            get
            {
                return (ushort)(1 + SA.Length + 1 + 1 + mAPDU.GetSize() + 4 + 2);
            }
        }
        ...
        public void ParseGET_Respone(List<byte> list, ref string code, ref List<string> data, ref bool result)
        {
            ...
            switch (getResponse)
            {
                ...
                case 0x01:
                    ...
                    list.RemoveAt(0);
                    byte[] bData = new byte[mDataSize];
                    list.CopyTo(0, bData, 0, mDataSize);
                    list.RemoveRange(0, mDataSize);
                    data.Add(bData._ToString(false));
