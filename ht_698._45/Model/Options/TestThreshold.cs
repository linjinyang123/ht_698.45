...
{
    public class TestThreshold : Threshold
    {
        ...
        public void Load()
        {
            组合电量 = mINIClass.ReadIniData("实验表阀值", "组合电量", "");
            正向电量 = mINIClass.ReadIniData("实验表阀值", "正向电量", "");
            反向电量 = mINIClass.ReadIniData("实验表阀值", "反向电量", "");
            时间误差 = mINIClass.ReadIniData("实验表阀值", "时间误差", "");
        }
        public void Save()
        {
            mINIClass.WriteIniData("实验表阀值", "组合电量", 组合电量);
            mINIClass.WriteIniData("实验表阀值", "正向电量", 正向电量);
            mINIClass.WriteIniData("实验表阀值", "反向电量", 反向电量);
            mINIClass.WriteIniData("实验表阀值", "时间误差", 时间误差);
        }
