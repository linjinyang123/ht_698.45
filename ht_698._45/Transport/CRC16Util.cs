...
namespace ht_698._45
{
    class CRC16Util
    {
        ...
        private static int[] CRC16_TABLE = {0x0000, 0x1189, 0x2312, 0x329b, 0x4624, 0x57ad, 0x6536, 0x74bf,
...
0x7bc7, 0x6a4e, 0x58d5, 0x495c, 0x3de3, 0x2c6a, 0x1ef1, 0x0f78
        ...
        /// <returns></returns>
        public byte[] makeCrc16(byte[] ccc)
        {
        ...
        {
            // 转换成字节数组
            crcString = crcString.Replace(" ", "").Trim();
        ...
        */
        ...
        /// <summary>
        /// string组转为字符串(byte帧格式转换为string帧格式)
        /// </summary>
        /// <param name="data"></param>
        /// <returns></returns>
        public static string stringArrayToString(byte[] data)
        {
            string tempString = "";
            foreach (byte b in data)
            {
                tempString = tempString + Convert.ToString(b, 16).PadLeft(2, '0') + " ";
            }
            return tempString;
        }
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public static string CharArrayToHexString(byte[] data)
        {
            string tempString = "";
            foreach (byte b in data)
            {
                tempString += Convert.ToString(Convert.ToChar(b));
            }
        ...
        /// <summary>
        /// string转为byte数组,每两个转换为一个byte数值值
        /// </summary>
        /// <param name="data"></param>
        /// <returns></returns>
        public static byte[] StringToByteArray(string data)
        {
            ...
            {
                tempByte[i] = Convert.ToByte(data.Substring(i * 2, 2), 16);
            }
            return tempByte;
        }
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public static string String10ToString16(string data)
        {
            string tempString = Convert.ToString(Convert.ToInt32(data), 16).PadLeft(2, '0');
            return tempString;
        }
    }
}